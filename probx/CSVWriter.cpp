...
//pair<size_t, double> iteration_mean(size_t n);
//
//future<pair<size_t, double>> tasks_results[TASK_COUNT];
//
//void main() {
//	size_t n, k;
//	k = 0;
...
//			tasks_results[j] = async(iteration_mean, cur_n);
//			cur_n++;
//		}
//
//		for (size_t j = 0; j < TASK_COUNT; j++) {
//			pair<size_t, double> res = tasks_results[j].get();
//			if (res.first > n) continue;
//			final_e(0, 0, res.first) = res.second;
//		}
//	}
//
...
//
//pair<size_t, double> iteration_mean(size_t n) {
//	printf("Started calculating E(%d)\n", n);
//
//	Array3D<double> x(n + 1, M + 1, M + 1, 0);
//	Array3D<double> y(1, n + 1, n + 1, 0);
//	Array3D<double> ee(1, 1, n + 1, 0);
//	double expected;
//
//	prob_X(x, n, M, M);
//	prob_Y(y, x, n, n, M);
//	expected = mean_E(ee, y, n);
//
//	printf("Finished calculating E(%d)\n", n);
//
//	return make_pair(n, expected);
//}
//
//static void create_csv_from_3d_array(string file_name, Array3D<double> &arr) {
//	fstream f_out;
